 ...
 * <br>
 * Note: Be careful when use UpdateProcedureDescriptor variables or caching
 * UpdateProcedureDescriptor instances, because instances could become invalid
 * during runtime (see {@link MetadataManager}).
 *
 * @author <a href="mailto:rongallagher@bellsouth.net">Ron Gallagher<a>
 * @version $Id: UpdateProcedureDescriptor.java,v 1.1 2007-08-24 22:17:29 ewestfal Exp $
 */
    ...
    implements Serializable, XmlCapable
{
     ...
     */
    public UpdateProcedureDescriptor(
